...
public class IEContent {
	...
	public static void preInit() {
		...
		itemMetal = new ItemIEBase("metal", 64, "ingotCopper", "ingotAluminum", "ingotLead", "ingotSilver", "ingotNickel", "ingotConstantan", "ingotElectrum", "ingotSteel", "dustIron", "dustGold",
				"dustCopper", "dustAluminum", "dustLead", "dustSilver", "dustNickel", "dustConstantan", "dustElectrum", "dustCoke", "dustQuartz", "dustHOPGraphite", "ingotHOPGraphite", "nuggetIron",
				"nuggetCopper", "nuggetAluminum", "nuggetLead", "nuggetSilver", "nuggetNickel", "nuggetConstantan", "nuggetElectrum", "nuggetSteel", "plateIron", "plateCopper", "plateAluminum",
				"plateLead", "plateSilver", "plateNickel", "plateConstantan", "plateElectrum", "plateSteel").setMetaHidden(31, 34, 35, 37);

		itemMaterial = new ItemIEBase("material", 64, "treatedStick", "waterwheelSegment", "windmillBlade", "hempFiber", "fabric", "windmillBladeAdvanced", "coalCoke", "gunpartBarrel", "gunpartDrum",
				"gunpartGrip", "gunpartHammer", "componentIron", "componentSteel", "slag", "stickIron", "stickSteel", "stickAluminum");
		...
		itemMold = new ItemIEBase("mold", 1, "plate", "gear", "rod", "bullet").setMetaHidden(1);
	...
	public static void init() {
		...
		// MetalPressRecipe.addRecipe(new ItemStack(itemMetal,1,31), "ingotCopper",
		// plateMould, 2400);
		...
		// MetalPressRecipe.addRecipe(new ItemStack(itemMetal,1,34), "ingotSilver",
		// plateMould, 2400, 200);
		// MetalPressRecipe.addRecipe(new ItemStack(itemMetal,1,35), "ingotNickel",
		// plateMould, 2400);
		MetalPressRecipe.addRecipe(new ItemStack(itemMetal, 1, 36), "ingotConstantan", plateMold, 2400);
		// MetalPressRecipe.addRecipe(new ItemStack(itemMetal,1,37), "ingotElectrum",
		// plateMould, 2400);
		...
		RailgunHandler.registerProjectileProperties(new ComparableItemStack("stickIron"), 9, 1.25).setColourMap(new int[][] { { 0xd8d8d8, 0xd8d8d8, 0xd8d8d8, 0xa8a8a8, 0x686868, 0x686868 } });
		...
		RailgunHandler.registerProjectileProperties(new ComparableItemStack("stickAluminum"), 8, 1.0625).setColourMap(new int[][] { { 0xd9ecea, 0xd9ecea, 0xd9ecea, 0xaebebc, 0x9aa7a6, 0x9aa7a6 } });
		RailgunHandler.registerProjectileProperties(new ComparableItemStack(new ItemStack(itemGraphiteElectrode)), 12, .9)
...
//		ThermoelectricHandler.registerSourceInKelvin("blockYellorium", 2000);
		...
		if (OreDictionary.doesOreNameExist("oreUranium") || OreDictionary.doesOreNameExist("oreYellorium"))
			ExcavatorHandler.addMineral("Uranium", 10, .35f, new String[] { "oreUranium", "oreLead", "orePlutonium", "denseoreUranium" }, new float[] { .55f, .3f, .1f, .05f })

...
public class MultiblockMetalPress implements IMultiblock {
	...
	public ItemStack[] getTotalMaterials() {
		return new ItemStack[] { new ItemStack(IEContent.blockMetalDecoration, 3, BlockMetalDecoration.META_scaffolding), new ItemStack(Blocks.piston),
				new ItemStack(IEContent.blockMetalDevice, 2, BlockMetalDevices.META_conveyorBelt), new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_heavyEngineering) };
	}
}
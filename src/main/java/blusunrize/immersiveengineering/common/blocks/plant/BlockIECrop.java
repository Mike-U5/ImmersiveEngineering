...
/**
 * Bottom plant has a meta 0 ~ 4 based on growth stage.
 * Top plant has meta value 5.
 */
public class BlockIECrop extends BlockBush implements IGrowable {
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
		...
		if (metadata >= 4) {
			final int quantity = (metadata >= 5 || world.rand.nextBoolean()) ? 2 : 1;
			ret.add(new ItemStack(IEContent.itemMaterial, quantity, 3));
		}
